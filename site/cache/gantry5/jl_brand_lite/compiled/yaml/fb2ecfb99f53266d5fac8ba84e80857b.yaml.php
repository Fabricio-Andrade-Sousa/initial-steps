...
return [
    ...
    'filename' => '/home/vol4_1/infinityfree.com/if0_35516079/htdocs/site/templates/jl_brand_lite/particles/jlnavbar.yaml',
    'modified' => 1701870211,
    'data' => [
        'name' => 'JL Navbar',
        ...
        'form' => [
            'fields' => [
                        ...
                        '_tab_header' => [
                            ...
                            'fields' => [
                                ...
                                'canvas_settings' => [
                                    'type' => 'separator.note',
                                    'class' => 'alert alert-info',
                                    'content' => 'Force Gantry 5 mobile menu (Offcanvas) instead using Uikit mobile modes, please check <a href="https://joomlead.com/g5/docs/jl-navbar-particle/#mobile-menu" target="_blank">this tutorial</a>'
                                ],
                                'g5canvas' => [
                                    'type' => 'input.checkbox',
                        ...
                        '_tab_dialog' => [
                            ...
                            'fields' => [
                                '_dialog_info' => [
                                    'type' => 'separator.note',
                                    'class' => 'alert alert-info',
                                    'content' => 'Setting the Dialog layout to display menus, modules, social icons, search form.'
                                ]
                            ]
                        ],
                        '_tab_general' => [
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Navbar Lite <strong>Version: 1.1.5</strong> by <a href="https://joomlead.com/" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/jl-navbar-particle/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
