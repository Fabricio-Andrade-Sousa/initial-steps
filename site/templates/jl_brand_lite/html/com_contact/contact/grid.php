...
<div class="com-contact contact el-contact-form" itemscope itemtype="https://schema.org/Person">
		...
		<div class="jl-width-1-3@m">
			<div class="jl-card jl-card-default">
				...
				<?php if ($this->item->image && $tparams->get('show_image')) : ?>
					<div class="com-contact__thumbnail jl-card-media-top">
				...
				<div class="g-content nomarginall jl-margin-remove-first-child">
				...
				<?php if ($this->item->misc && $tparams->get('show_misc')) : ?>
					<?php echo '<' . $htag2 . ' class="jl-margin-remove-top">' . Text::_('COM_CONTACT_OTHER_INFORMATION') . '</' . $htag2 . '>'; ?>

					<div class="com-contact__miscinfo contact-miscinfo jl-margin-remove-last-child">
	...
	<?php endif; ?>
		...
		<?php if ($tparams->get('show_email_form') && ($this->item->email_to || $this->item->user_id)) : ?>
			<div class="jl-tile-default jl-box-shadow-small g-content nomarginall">
